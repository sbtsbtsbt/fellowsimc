...
struct player_t : public actor_t
{
  ...
  struct base_initial_current_t
  {
    ...
    double spell_crit_chance, attack_crit_chance, block_reduction, mastery, versatility, haste;
...
public:
  ...
  real_ppm_t* get_rppm( std::string_view name, double frequency = 0.0, double modifier = 1.0,
                        unsigned scales_with = RPPM_HASTE, real_ppm_t::blp blp_state = real_ppm_t::blp::BLP_ENABLED );
